    ...
    <div class="business">
        ...
        <template slot-scope="scope">
          <el-radio v-model="tableRadioOne" :label="scope.row" @change="handleSelectionChangeOne">
            ...
            >
                <template slot-scope="scope">
                    <span class="companyID" @click="openCompanyDetails(scope.row.comp_CD)">{{
                        scope.row.comp_CD
                    }}</span>
                </template>
            </el-table-column>
            ...
            >
                <template slot-scope="scope">
                    {{
                        scope.row.comp_Hash_Datetime == null
                            ? '暂无存证时间'
                            : changeTimestampInfo(scope.row.comp_Hash_Datetime * 1000)
                    }}
                </template>
            </el-table-column>
            <el-table-column
        ...
        <template slot-scope="scope">
          <el-radio v-model="tableRadioOne" :label="scope.row" @change="handleSelectionChange">
            ...
            <el-table-column prop="photo_CD" label="资料编码" align="center" width="100">
                <template slot-scope="scope">
                    <span class="companyID" @click="openInfoDetails(scope.row.photo_CD)">{{
                        scope.row.photo_CD
                    }}</span>
                </template>
            </el-table-column>
      ...
      <el-table-column prop="photo_Hash_Datetime" label="总Hash时间" width="200" align="center">
        ...
        <div class="business-block">
            ...
            >
                    ...
                    <div class="business-add-business">
                        ...
                        >
                            <el-form-item label="企业编码:" prop="compCD">
                                <el-input v-model="addCompanyForm.compCD" id="inputId"></el-input>
                            </el-form-item>
                ...
                <el-input v-model="addCompanyForm.companyWebsite"></el-input>
                            ...
                            <el-form-item style="width:100%" label="企业LOGO:" class="compLOGO">
                                ...
                                >
                                    <el-button size="small" type="primary"
                                        >上传企业LOGO( png / jpg / jpeg / gif / tiff
                                        格式,限1张,尺寸小于150*150,长宽比例为7:4)</el-button
                                    >
                                </el-upload>
                            </el-form-item>
                            ...
                            <el-form-item style="width:100%;">
                                ...
                                <el-button type="primary" @click="submitFormOne('addCompanyForm')"
                                    >提 交</el-button
                                >
                            </el-form-item>
                        </el-form>
                ...
                <div class="business-add-content">
                    ...
                    >
                        <el-form-item label="企业编码:" prop="comp_CD">
                            <el-input
                                :value="
                                    infoComDeatils.comp_CD == null
                                        ? '请先选择企业'
                                        : infoComDeatils.comp_CD
                                "
                                :disabled="true"
                                style="width:250px"
                            ></el-input>
                        ...
                        <el-form-item label="企业地址:" prop="comp_Address">
                            <el-input
                                :value="
                                    infoComDeatils.comp_Address == null
                                        ? '请先选择企业'
                                        : infoComDeatils.comp_Address
                                "
                                :disabled="true"
                                style="width:250px"
                            ></el-input>
                        ...
                        <el-form-item label="企业名称:" prop="comp_Name">
                            <el-input
                                :value="
                                    infoComDeatils.comp_Name == null
                                        ? '请先选择企业'
                                        : infoComDeatils.comp_Name
                                "
                                :disabled="true"
                                style="width:250px"
                            ></el-input>
                        ...
                        <el-form-item label="企业简称:" prop="comp_Simp_Name">
                            <el-input
                                :value="
                                    infoComDeatils.comp_Simp_Name == null
                                        ? '请先选择企业'
                                        : infoComDeatils.comp_Simp_Name
                                "
                                :disabled="true"
                                style="width:250px"
                            ></el-input>
                        ...
                        <el-form-item label="企业法人:" prop="comp_Leader">
                            <el-input
                                :value="
                                    infoComDeatils.comp_Leader == null
                                        ? '请先选择企业'
                                        : infoComDeatils.comp_Leader
                                "
                                :disabled="true"
                                style="width:250px"
                            ></el-input>
                        ...
                        <el-form-item label="法人电话:" prop="leader_Phone">
                            <el-input
                                :value="
                                    infoComDeatils.leader_Phone == null
                                        ? '请先选择企业'
                                        : infoComDeatils.leader_Phone
                                "
                                :disabled="true"
                                style="width:250px"
                            ></el-input>
                        ...
                        <el-form-item label="联系人:" prop="comp_Contact">
                            <el-input
                                :value="
                                    infoComDeatils.comp_Contact == null
                                        ? '请先选择企业'
                                        : infoComDeatils.comp_Contact
                                "
                                :disabled="true"
                                style="width:250px"
                            ></el-input>
                        ...
                        <el-form-item label="联系电话:" prop="cont_Phone">
                            <el-input
                                :value="
                                    infoComDeatils.cont_Phone == null
                                        ? '请先选择企业'
                                        : infoComDeatils.cont_Phone
                                "
                                :disabled="true"
                                style="width:250px"
                            ></el-input>
                        ...
                        <el-form-item style="width:100%" label="企业图片:" class="addInfoImg">
                            <el-upload
                                ...
                                :auto-upload="false"
                            >
                                <el-button size="small" type="primary" label="企业图片:"
                                    >上传企业图片( png / jpg / jpeg / gif / tiff
                                    格式,限1张,尺寸小于150*150,长宽比例为7:4)</el-button
                                >
                            </el-upload>
                        ...
                        >
                            ...
                            >
                                <el-button size="small" type="primary"
                                    >上传企业资质证照( png / jpg / jpeg / gif / tiff
                                    格式,限1张,尺寸小于150*150,长宽比例为7:4)</el-button
                                >
                            </el-upload>
                        </el-form-item>
                        <el-form-item style="width:100%" label="其他图片:" class="addInfoImg">
                            ...
                            >
                                <el-button size="small" type="primary"
                                    >上传企业其他图片( png / jpg / jpeg / gif / tiff
                                    格式,限1张,尺寸小于150*150,长宽比例为7:4)</el-button
                                >
                            </el-upload>
                        </el-form-item>
                        <el-form-item style="width:100%">
                            ...
                            <el-button type="primary" @click="submitFormTwo('addInfoForm')"
                                >提 交</el-button
                            >
                        </el-form-item>
                    </el-form>
            ...
            <!-- 资料新增弹出框结束-->
            <el-dialog title="资料详情" :visible.sync="dialogVisibleThree" v-dialogDrag center>
                <span>
                    <div
                        style="height:100%"
                    ...
                    >
                        <div style="height:100%">
                            <el-row>
                                <el-button style="float:left" @click="toFirst('1')"
                                    >首 条</el-button
                                >
                                <el-button
            ...
            <el-dialog title="企业详情" :visible.sync="dialogVisibleFour" v-dialogDrag width="50%">
                <span>
                    <!-- 企业详情弹出框开始 -->
                    ...
                    >
                        <el-form-item label="企业编码:">
                            <el-input
                                v-model="companyDetails.comp_CD"
                                style="width:300px"
                                disabled
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="企业名称:">
                            <el-input
                                v-model="companyDetails.comp_Name"
                                style="width:300px"
                                disabled
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="企业简称:">
                            <el-input
                                v-model="companyDetails.comp_Simp_Name"
                                style="width:300px"
                                disabled
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="企业地址:">
                            <el-input
                                v-model="companyDetails.comp_Address"
                                style="width:300px"
                                disabled
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="企业法人:">
                            <el-input
                                v-model="companyDetails.comp_Leader"
                                style="width:300px"
                                disabled
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="法人电话:">
                            <el-input
                                v-model="companyDetails.leader_Phone"
                                style="width:300px"
                                disabled
                            ></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="联系人:">
                            <el-input
                                v-model="companyDetails.comp_Contact"
                                style="width:300px"
                                disabled
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="联系人电话:">
                            <el-input
                                v-model="companyDetails.cont_Phone"
                                style="width:300px"
                                disabled
                            ></el-input>
                        </el-form-item>
                ...
                <el-input v-model="addCompanyForm.companyWebsite"></el-input>
                        ...
                        <el-form-item label="企业网址:" prop="comp_URL">
                            <el-input
                                v-model="companyDetails.comp_URL"
                                disabled
                                style="width:715px"
                            ></el-input>
                        </el-form-item>
            ...
            >
                <span>
                    ...
                    >
                        ...
                        <el-form-item label="企业简称:" prop="comp_Simp_Name">
                            <el-input
                                v-model="editData.comp_Simp_Name"
                                style="width:280px"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="企业地址:" prop="comp_Address">
                            <el-input
                                v-model="editData.comp_Address"
                                style="width:280px"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="企业法人:" prop="comp_Leader">
                        ...
                        <el-form-item label="法人电话:" prop="leader_Phone">
                            <el-input
                                v-model="editData.leader_Phone"
                                style="width:280px"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="联系人:" prop="comp_Contact">
                            <el-input
                                v-model="editData.comp_Contact"
                                style="width:280px"
                            ></el-input>
                        </el-form-item>
                        ...
                        <el-form-item style="width:100%;margin-top:10px">
                            ...
                            <el-button type="primary" @click="submitForm('editData')"
                                >提 交</el-button
                            >
                        </el-form-item>
                    </el-form>
...
export default {
    data() {
        ...
        let validateuserComCD = (rule, value, callback) => {
            let reg = /^[a-z_A-Z0-9-\.!@#\$%\\\^&\*\)\(\+=\{\}\[\]\/",'<>~\·`\?:;|]+$/;
            if (!reg.test(value)) {
        ...
        return {
            editDataRules: {
                ...
                leader_Phone: [{ required: true, message: '请输入法人电话', trigger: 'blur' }],
                comp_Name: [
                ...
                cont_Phone: [{ required: true, message: '请输入联系人电话', trigger: 'blur' }],
                comp_URL: [
                    {
                        min: 1,
                        max: 100,
    ...
    methods: {
        ...
        handleDeleteOne(index, row) {
            this.$confirm('此操作将永久删除该企业, 是否继续?', '提示', {
                ...
                .then(() => {
                    this.loadingTwo = true;
                    delComp({ compCD: row.comp_CD }, this.$store.getters.token).then((res) => {
                        if (res.code == 1) {
                            this.$notify({
                                title: '成功!',
                                message: '删除成功!',
        ...
        handleDeleteTwo(index, row) {
            this.$confirm('此操作将永久删除该条资料, 是否继续?', '提示', {
                ...
                .then(() => {
                    this.loadingInfo = true;
                    delData({ photoCD: row.photo_CD }, this.$store.getters.token).then((res) => {
                        if (res.code == 1) {
                            dataForCD(
                                {
                                    compCD: row.comp_CD,
        ...
        layData() {
            if (!this.dataEnvList.length) {
                ...
                inputDataHash({ photoCDs: infoEnvData }, this.$store.getters.token).then((res) => {
        ...
        addCompanyDia() {
            ...
            Object.keys(this.addCompanyForm).forEach((key) => (this.addCompanyForm[key] = ''));
            this.logoList = [];
            this.photoList = [];
        },
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    if (
                        ...
                        for (let i = 0; i < this.addInfoForm.compDataPhoto_comp.length; i++) {
                            formData.append(
                                'compDataPhoto_comp',
                        ...
                        for (let m = 0; m < this.addInfoForm.compDataPhoto_qua.length; m++) {
                            formData.append(
                                'compDataPhoto_qua',
                                this.addInfoForm.compDataPhoto_qua[m].raw
                            );
                        }
                        for (let o = 0; o < this.addInfoForm.compDataPhoto_others.length; o++) {
                            formData.append(
                                'compDataPhoto_others',
