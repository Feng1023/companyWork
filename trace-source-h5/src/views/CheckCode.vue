        ...
        <div class="info">
          ...
          <div class="sts">
            状态：<span class="status">{{
              codeDetail.consume_Status | getStatus
            }}</span>
          </div>
        </div>
      </div>
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <img
          src="../assets/bigger.png"
          alt=""
          @click="openDialog(codeDetail.comp_Hash)"
        />
      </div>
      <div class="detail">
        <div>企业名称</div>
